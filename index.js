...
window.onload = function(){
	...
	img.onload = function(){
		...
		// 截取图片
		// bitmap.sourceRect = new cjs.Rectangle(0,0,100,100)
		// const card = new Card(img,new cjs.Rectangle(0,0,100,100))
		// stage.addChild(card)
		getCard()
	...
	// 卡片数量  横 竖
	const ROW_NUM = 4,COL_NUM = 6
	// 方向
	const DIR_LEFT = 'left',DIR_RIGHT = 'right',DIR_UP = 'up',DIR_DOWN = 'down',DIR_NONE = 'none'
	let cardWidth,cardHeight,cardArr = []
	// 空白卡片的位置
	let currentNullIndexRow = 0,currentNullIndexCol = 0
	// 截取小卡片
	function getCard(){
	...
	// 打乱图片
	let lastMoveDir = DIR_NONE // 上次移动的方向
	function breakCards(){
		if(!breaking){
			return
		}
